...
//? First position is 0. Second posittion is 1.
...
// console.log(originalString.replace(/world/gi, "vinod"));
...
// let CheckV = (stc) =>{
//     let vovle = `aeiou` 
//     for (let char of vovle) {
//         console.log(char);
//         if (!stc.includes(char)) {
//             return false
//         }
//     }
//     return true
...
// console.log(CheckV(`i use NixOS in my oled laptop`))
...
// console.log(checkV("my name u is vinod @  thapa"));

...
// const myForEachArr = fruits.forEach((elm, i, a) => {
//   return `${elm} ${i}`;
//     console.log(a);
// });
...
// const numbers = [1, 2, 3, 4, 85, 6, 7, 8, 9];

// // const result = numbers.map((curElem) => curElem * 5);
// // console.log(result);
// const result2 = numbers.findIndex((curElem) => {
//   return curElem > 7;
// });
// console.log(result2);
...
// let updatedCart = n.filter((curElem) => {
//   return curElem !== v;
// });
...
// const filterProducts = p.filter((curElem) => {
...
// const numbers = [1, 2, 4, 3, 9824, 525, 6, 7, 4254, 8, 9];
...
// p = n.map((curElem) => curElem * curElem);
// console.log(p);
...
// const w = ["APPLE", "banana", "cherry", "date"];

// let u = w.map((e)=>{return e.toUpperCase()})
// console.log(u);

// const result = w.map((curElem) => {
